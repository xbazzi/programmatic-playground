...
int main()
{
    ...
    std::uint64_t double_clock_seed = std::chrono::steady_clock::now().time_since_epoch().count() ^ std::chrono::system_clock::now().time_since_epoch().count();
    std::uint64_t thread_double_clock_seed = std::chrono::steady_clock::now().time_since_epoch().count() ^ std::chrono::system_clock::now().time_since_epoch().count() ^ std::hash<std::thread::id> {}(std::this_thread::get_id());
